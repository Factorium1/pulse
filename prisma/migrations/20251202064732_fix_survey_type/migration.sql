/*
  ...
  - The values [ONE_SHOT,MULTI_DAY] on the enum `SurveyType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "SurveyType_new" AS ENUM ('SHORT', 'LONG');
...
ALTER TABLE "Survey" ALTER COLUMN "type" SET DEFAULT 'SHORT';
COMMIT;
