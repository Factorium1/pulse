...
const Header = () => {
  return (
    <div className="sticky top-10 z-10 w-sm flex-between backdrop-blur-sm bg-opacity-30 bg-white/30 border border-gray-300 md:w-lg mx-auto px-5 py-3 rounded-full ">
