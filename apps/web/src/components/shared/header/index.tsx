...
const Header = () => {
  return (
    <div className="min-w-[300px] fixed left-1/2 top-10 z-10 -translate-x-1/2 flex-between backdrop-blur-sm bg-opacity-30 bg-white/30 border border-gray-300 md:w-lg px-5 py-3 rounded-full">
      <Link href="#home">
